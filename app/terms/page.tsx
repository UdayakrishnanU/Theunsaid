...
export default function TermsPage() {
  return (
    <div className="page">
      ...
      <p className="lastup">
        This is an electronic record under the Information Technology Act, 2000 and its amended provisions relating to electronic records,
        generated by a computer system and requiring no physical or digital signature. It is published under Rule 3(1) of the Information
        Technology (Intermediaries Guidelines) Rules, 2011, for the domain <span className="ph">https://www.anonverdict.com</span> (&quot;Platform&quot;),
        owned and operated by <strong>AnonVerdict</strong> (&quot;Platform Owner&quot;, &quot;we&quot;, &quot;us&quot;, &quot;our&quot;), registered
        address No. 36 Sivaraj Main Street, Puzhal, Chennai 600066, Tamil Nadu, India.
      </p>
      ...
      <h3>12. How to complain / Grievance Officer</h3>
      <p>
        If something here has gone wrong — a post about you, a payment that misfired, anything — write to{" "}
        <span className="ph">contact@anonverdict.com</span>, our designated grievance contact under the Information Technology (Intermediaries
        Guidelines) Rules, 2011. A real person reads it. We acknowledge within 24 hours and aim to resolve within 15 days.
      </p>
      <p>
        These Terms are governed by the laws of India. Any dispute arising out of or relating to them is subject to the exclusive jurisdiction of
        the courts in Chennai, Tamil Nadu — alongside any rights your own local consumer-protection law gives you that we cannot sign away.
      </p>
      <p className="lastup">
